...
@Component({
 ...
 providers: [
  ...
  templateUrl: './braco-modal-form.component.html',
  styleUrl: './braco-modal-form.component.scss'
})
export class BracoModalFormComponent {
  loading = false;
  bracoForm: FormGroup;
  ...
  onSubmit(): void {
    ...
    saveOperation.subscribe({
      next: () => {
        ...
        this.router.navigate(['/admin/braco/edit/', this.bracoId]);
      },
      error: (error) => {
        this.loading = false;
